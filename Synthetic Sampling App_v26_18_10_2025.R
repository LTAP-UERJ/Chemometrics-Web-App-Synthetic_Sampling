        ...
        fluidRow(
          ...
          box(title = "Exportação de Dados", status = "info", solidHeader = TRUE, width = 6,
              selectInput("dataset_choice", "Escolha o conjunto de dados:", 
                          ...
                          choices = c("Amostras Originais" = "original", "Amostras Combinadas" = "combined", "Amostras Removidas" = "removed")),
              p(strong("Amostras Removidas:"), "Opção válida apenas para Downsampling e Híbrido caso tenha amostras removidas") , #ADICIONADO EM 16/06/2025/ ATUALIZADO EM 02/07/2025
              ###########MODIFICADO EM 07/05/2025#####################
      ...
      tabItem(
        ...
        fluidRow(
          ...
          box(
            ...
            #p(strong("Obs:"), "Variáveis com desvio padrão igual a zero foram removidas."),
            p(em("Observação: Variáveis com desvio padrão igual a zero foram removidas.")), # MODIFICADO EM 14/06/2025
          ...
          #ACRÉSCIMO DA DESCRIÇÃO DA HIPÓTESE NULA EM TESTES DE VARIÂNCIA EM 28/03/2025
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            p(strong("Escolha como as classes devem ser tratadas na remoção:"), " "),
            p(strong(".auto"), em("remove amostras da classe majoritária que formam pares Tomek;")),
            p(strong(".all"), em("remove ambas as amostras em cada par Tomek;")),
            p(strong(".majority"), em("remove apenas a amostra da classe majoritária nos pares;")),
            p(strong(".not minority"), em("remove todas exceto a minoritária;")),
            p(strong(".not majority"), em("remove todas exceto a majoritária.")),
            ...
            # Observações
            p(strong("obs:"), "Tomek Links é um método de downsampling que remove ruído e amostras ambíguas próximas da fronteira entre classes."),
            p(strong("obs:"), "Este método é especialmente útil para limpar regiões de sobreposição entre classes."),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            p(strong("Escolha como as classes devem ser tratadas na seleção de amostras da majoritária:")),
            p(strong(".auto:"), em("Remove amostras da classe majoritária até balancear com a minoritária")),
            p(strong(".all:"), em("Remove amostras de todas as classes até balancear entre todas.")),
            p(strong(".majority:"), em("Remove exclusivamente da classe majoritária.")),
            p(strong(".not minority:"), em("Remove de todas as classes exceto a minoritária.")),
            p(strong(".not majority:"), em("Remove de todas as classes exceto a majoritária.")),
            ...
            selectInput(
              ...
              label = "Versão do algoritmo NearMiss:",
              choices = c("1", "2", "3"),
              selected = "1"
            ),
            ...
            numericInput(
              ...
              label = "Número de vizinhos (n_neighbors):",
              value = 3,
              min = 1
            ),
            ...
            numericInput(
              ...
              label = "Vizinhos para minoria (n_neighbors_ver3 - apenas versão 3):",
              value = 3,
              min = 1
            ),
            ...
            numericInput(
              ...
              label = "Número de threads (n_jobs):",
              value = -1,
              min = -1
            ),
            ...
            p(strong("Sobre o NearMiss:")),
            p("Método de undersampling baseado em distâncias."),
            p("A versão 1 seleciona amostras da classe majoritária com menor distância média para os k vizinhos da minoria."),
            p("A versão 2 considera a distância média dos k vizinhos mais distantes da minoria."),
            p("A versão 3 seleciona amostras da majoritária com menor distância para os k vizinhos da minoria."),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            p(strong("Escolha como as classes devem ser tratadas na edição baseada em vizinhos:")),
            p(strong(".auto:"), em("Remove amostras das classes majoritárias até balancear com a minoritária.")),
            p(strong(".all:"), em("Remove amostras de todas as classes até o balanceamento total.")),
            p(strong(".majority:"), em("Remove apenas da classe majoritária.")),
            p(strong(".not minority:"), em("Remove de todas as classes exceto a minoritária.")),
            p(strong(".not majority:"), em("Remove de todas as classes exceto a majoritária.")),
            ...
            selectInput(
              ...
              label = "Critério de remoção (kind_sel):",
          ...
          selected = "all"
            ...
            # Explicações informativas
            p(strong("Sobre o Edited Nearest Neighbours (ENN):")),
            p("Técnica de downsampling que remove amostras com base na discordância com seus vizinhos mais próximos."),
            p("Amostras são removidas se sua classe for diferente da maioria (ou de todos) dos vizinhos."),
            p(strong("kind_sel = 'all':"), " remove amostras cujos vizinhos possuem todas classes diferentes."),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            p(strong("Escolha como as classes devem ser tratadas no processo de remoção:")),
            p(strong(".auto:"), em("Remove amostras das classes majoritárias até balancear com a minoritária.")),
            p(strong(".all:"), em("Remove amostras de todas as classes até o balanceamento total.")),
            p(strong(".majority:"), em("Remove apenas da classe majoritária.")),
            p(strong(".not minority:"), em("Remove de todas as classes exceto a minoritária.")),
            ...
            numericInput(
              ...
              label = "Número de amostras SEEDs (n_seeds_S):",
              value = 1,
              min = 1
            ),
            ...
            numericInput(
              ...
              label = "Semente aleatória (random_state):",
              value = 42
            ),
            ...
            p(strong("Sobre o One-Sided Selection (OSS):")),
            p("Combina a remoção de ruídos (via ENN) com a ideia de redução de instâncias da classe majoritária."),
            p("O OSS usa exemplos da minoria como sementes (SEEDs) e remove amostras majoritárias desnecessárias."),
            p("É útil quando se quer manter o máximo de exemplos relevantes da minoria com menos ruído."),
            p(strong("n_neighbors:"), " define quantos vizinhos o algoritmo considera ao decidir remoção."),
            p(strong("n_seeds_S:"), " número de exemplos da minoria que são usados como referência (sementes)."),
            p(strong("random_state:"), " controla a aleatoriedade para reprodutibilidade."),
            p(strong("n_jobs:"), " permite paralelização do processo. Use -1 para usar todos os núcleos."),
        ...
        fluidRow(
          box(
            ...
            checkboxInput(
              ...
              label = "Permitir substituição ao subamostrar? (replacement)",
              value = FALSE
            ),
            ...
            p(strong("Sobre o Random Downsampling:")),
            p("Remove aleatoriamente amostras das classes majoritárias para balancear o conjunto de dados."),
            p("É útil quando o objetivo é reduzir o viés causado por classes desbalanceadas, sem introduzir novos dados."),
            p(strong("sampling_strategy:"), " define como o balanceamento será feito entre as classes."),
            p(strong("random_state:"), " controla a aleatoriedade para reprodutibilidade."),
            p(strong("replacement:"), " se verdadeiro, amostras podem ser removidas com reposição (repetição possível)."),
        ...
        fluidRow(
          box(
            ...
            numericInput(
              ...
              label = "Tamanho final desejado para cada classe (m):",
              value = 20,
              min = 1
            ),
            ...
            hr(),
            p(strong("Sobre SBC (undersample_kmeans):")),
            p("Executa subamostragem com base em agrupamento para as classes selecionadas."),
            p("Classes não selecionadas permanecem intactas."),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            p(strong("Escolha como as classes devem ser tratadas no processo de over + undersampling:")),
            p(strong(".auto:"), em("Reamostra todas as classes para igualar à maioria.")),
            p(strong(".all:"), em("Reamostra todas as classes para total balanceamento.")),
            p(strong(".minority:"), em("Apenas a classe minoritária é superamostrada.")),
            p(strong(".not minority:"), em("Todas as classes exceto a minoritária são tratadas.")),
            p(strong(".not majority:"), em("Todas as classes exceto a majoritária são tratadas.")),
            ...
            numericInput(
              ...
              label = "Número de vizinhos (k_neighbors):",
              value = 5,
              min = 1
            ),
            ...
            p(strong("Sobre o SMOTE Tomek Links:")),
            p("Combina SMOTE (geração de amostras sintéticas da classe minoritária) com Tomek Links (remoção de amostras ambíguas entre classes)."),
            p("É útil para melhorar a separabilidade entre classes enquanto reduz sobreposição."),
            p(strong("sampling_strategy:"), " define como as classes serão balanceadas."),
            p(strong("k_neighbors:"), " número de vizinhos utilizados para gerar novas amostras sintéticas."),
            p(strong("random_state:"), " define a semente de aleatoriedade para reprodutibilidade."),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            p(strong("Escolha como as classes devem ser tratadas no processo de over + undersampling:")),
            p(strong(".auto:"), em("Reamostra todas as classes para igualar à majoritária.")),
            p(strong(".all:"), em("Reamostra todas as classes para total balanceamento.")),
            p(strong(".minority:"), em("Apenas a classe minoritária é superamostrada.")),
            p(strong(".not minority:"), em("Todas as classes exceto a minoritária.")),
            p(strong(".not majority:"), em("Todas as classes exceto a majoritária.")),
            ...
            p(strong("Sobre o SMOTE ENN:")),
            p("Combina SMOTE (geração de amostras sintéticas) com Edited Nearest Neighbours (remoção de amostras mal classificadas por seus vizinhos)."),
            p("É útil para reduzir ruído e melhorar a separação entre classes."),
            p(strong("sampling_strategy:"), " define como as classes serão balanceadas."),
            p(strong("k_neighbors:"), " número de vizinhos utilizados para gerar novas amostras sintéticas e para aplicar ENN."),
            p(strong("random_state:"), " define a semente aleatória para reprodutibilidade."),
       ...
       fluidRow(
         box(
           ...
           numericInput(
             ...
             label = "Número de vizinhos para SMOTE (k_neighbors):",
             value = 5,
             min = 1
           ),
           ...
           numericInput(
             ...
             label = "Número de estimadores para o filtro IPF (classifiers):",
             value = 5,
             min = 1
           ),
           ...
           numericInput(
             ...
             label = "Número máximo de iterações IPF (max_iter):",
             value = 20,
             min = 1
           ),
           ...
           p(strong("Sobre o SMOTE IPF:")),
           p("Combina SMOTE com um filtro IPF (Iterative Partitioning Filter) para remover amostras ruidosas de forma iterativa."),
           p("Útil quando se quer melhorar a qualidade das amostras sintéticas eliminando ruídos."),
           p(strong("k_neighbors:"), " número de vizinhos usados pelo SMOTE para gerar amostras."),
           p(strong("classifiers:"), " número de estimadores de base para identificar ruído."),
           p(strong("max_iter:"), " número máximo de iterações para o filtro IPF."),
           p(strong("random_state:"), " define a semente para reprodutibilidade."),
       ...
       fluidRow(
         box(
           ...
           numericInput(
             ...
             label = "Número de vizinhos para Borderline-SMOTE (k_neighbors):",
             value = 5,
             min = 1
           ),
           
           # Filtro de ruído: ENN fixo
           p(strong("Filtro de ruído:"),
             " será usado o ENN (Edited Nearest Neighbours) automaticamente após o Borderline-SMOTE."),
           ...
           p(strong("Sobre o SPIDER:")),
           p("O SPIDER combina Borderline-SMOTE com um filtro de ruído ENN."),
           p("Gera novas amostras sintéticas em regiões borderline e remove ruídos (pequenas disjunções)."),
           p(strong("k_neighbors:"), " número de vizinhos usados pelo Borderline-SMOTE para gerar amostras."),
           p(strong("random_state:"), " define a semente para reprodutibilidade."),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$runBorderlineSMOTE, {
    ...
    tryCatch({
      ...
      showNotification("Erro: k_neighbors muito alto. Ajuste necessário.", type = "error")
  ...
  observeEvent(input$runTomek, {
    ...
    if (any(class_counts < 2)) {
      showNotification("Alguma classe tem menos de 2 amostras.", type = "error")
      return()
    }
    ...
    # Definindo amostras removidas como "sintéticas negativas"
  ...
  observeEvent(input$runNearMiss, {
    ...
    if (any(class_counts < 3)) {
      showNotification("Alguma classe tem menos de 3 amostras para usar NearMiss.", type = "error")
      return()
    }
  ...
  observeEvent(input$runENN, {
    ...
    class_counts <- table(y)
    if (any(class_counts < 3)) {
      showNotification("Alguma classe tem menos de 3 amostras para usar ENN.", type = "error")
      return()
    }
  ...
  observeEvent(input$runOSS, {
    ...
    class_counts <- table(y)
    if (any(class_counts < 3)) {
      showNotification("Alguma classe tem menos de 3 amostras para usar OSS.", type = "error")
      return()
    }
  ...
  observeEvent(input$runRD, {
    ...
    class_counts <- table(y)
    if (any(class_counts < 2)) {
      showNotification("Alguma classe tem menos de 2 amostras para usar Random Downsampling.", type = "error")
      return()
    }
  ...
  output$classes_to_undersample_sbc <- renderUI({
    ...
    selectInput(
      "sbc_classes",
      "Selecione as classes para subamostrar:",
      choices = cls,
      multiple = TRUE
    )
  })
  ...
  observeEvent(input$runSBC, {
    ...
    for (cls in classes_selected) {
      ...
      sbc_res <- tryCatch({
        ...
        showNotification(paste("Erro no SBC para classe", cls, ":", e$message), type = "error")
        return(NULL)
      })
    ...
    showNotification("SBC executado com sucesso!", type = "message")
  })
...
#  })
  ...
  observeEvent(input$runSMOTETL, {
    ...
    class_counts <- table(y)
    if (any(class_counts < 2)) {
      showNotification("Alguma classe tem menos de 2 amostras para aplicar SMOTE-TL.", type = "error")
      return()
    }
    ...
    if (k_safe < 1) {
      showNotification("Classe minoritária tem amostras insuficientes para o número de vizinhos definido.", type = "error")
      return()
    }
    ...
    # Detectando amostras sintéticas
  ...
  # Tabela de removidas e sintéticas(adicionadas)
  ...
  output$gen_table_tl <- renderTable({
    if (isTRUE(runSMOTETL())) {
      ...
      if (nrow(removed) > 0) {
        removed$origem <- "Removida"
      } else {
        removed <- NULL
      }
      
      if (nrow(synthetic) > 0) {
        synthetic$origem <- "Sintética"
      } else {
        synthetic <- NULL
      }
  ...
  observeEvent(input$runSMOTEENN, {
    ...
    class_counts <- table(y)
    if (any(class_counts < 2)) {
      showNotification("Alguma classe tem menos de 2 amostras para aplicar SMOTE-ENN.", type = "error")
      return()
    }
  ...
  observeEvent(input$runSMOTEIPF, {
    ...
    for (cls in classes) {
      ...
      # Final DATA = originais não removidas + sintéticas
  ...
  output$gen_table_ipf <- renderTable({
    if (isTRUE(runSMOTEIPF())) {
      ...
      if (!is.null(removed)) removed$origem <- "Removida"
      if (!is.null(synthetic)) synthetic$origem <- "Sintética"
  ...
  # Diagnóstico: Distribuição das Classes para Tomek Links EM 09/06/2025
  ...
  output$class_dist_tomek <- renderPlotly({
    ...
    if (is.null(cleaned_data) || !"class" %in% colnames(cleaned_data)) {
      ...
      df_removed <- data.frame(
        ...
        Classe = paste0(names(removed_aligned), " Removida"), #ALTERADO EM 29/06/2025
        Contagem = as.numeric(removed_aligned),
        #  Tipo = paste0(names(removed_aligned), " Removida")
        Tipo = paste0(names(removed_aligned), " Removida") #ALTERADO EM 29/06/2025
      )
      
      # Removendo classes sem remoção
      
      df_removed <- df_removed[df_removed$Contagem > 0, ]
  ...
  # Diagnóstico: Distribuição das Classes para NearMiss EM 16/06/2025
  ...
  # Diagnóstico: Distribuição das Classes para ENN EM 17/06/2025
  ...
  # Diagnóstico: Distribuição das Classes para OSS EM 18/06/2025
  ...
  # Diagnóstico: Distribuição das Classes para RD EM 18/06/2025
  ...
  # Diagnóstico: Distribuição das Classes para SBC em 10/07/2025
  ...
  # Diagnóstico: Distribuição das Classes para SMOTE-TL EM 18/06/2025
  ...
  output$class_dist_tl <- renderPlotly({
    ...
    if (!is.null(syn_data) && nrow(syn_data) > 0) {
      ...
      df_synthetic <- data.frame(
        Classe = paste0(names(syn_counts), " Sintética"),
        Contagem = as.numeric(syn_counts),
        Tipo = paste0(names(syn_counts), " Sintética")
      )
    ...
    if (!is.null(removed_data) && nrow(removed_data) > 0) {
      ...
      df_removed <- data.frame(
        Classe = paste0(names(removed_counts), " Removida"), #ALTERADO EM 29/06/2025
        Contagem = as.numeric(removed_counts),
        Tipo = paste0(names(removed_counts), " Removida") #ALTERADO EM 29/06/2025
      )
  ...
  # Diagnóstico: Distribuição das Classes para SMOTE-ENN EM 03/07/2025
  ...
  # Diagnóstico: Distribuição das Classes para SMOTE IPF EM 13/07/2025
  ...
  # Diagnóstico: Distribuição das Classes para SPIDER EM 14/07/2025
  ...
  output$class_dist_spider <- renderPlotly({
    ...
    if (!is.null(removed_data) && nrow(removed_data) > 0) {
      removed_counts <- table(as.factor(removed_data$class))
      df_removed <- data.frame(
        Classe = paste0(names(removed_counts), " Removida"),
        Contagem = as.numeric(removed_counts),
        Tipo = paste0(names(removed_counts), " Removida")
      )
      df_plot <- rbind(df_plot, df_removed)
      
      #filtrando contagens maiores que zero
      
      df_plot <- df_plot[df_plot$Contagem > 0, , drop = FALSE]
    }
  ...
  output$class_dist_switch <- renderUI({
    if (isTRUE(runSMOTENC())) {
      ...
      h5("Nenhum método executado ainda.") # MODIFICADO EM 14/06/2025 
    }
  })
    ...
    ######BLOCO MODIFICADO EM 28/06/2025
      ...
      if (is.null(added_data) || nrow(added_data) == 0) {
        ...
        if ("class" %in% names(added_data) || class_col %in% names(added_data)) {
          ...
          added_data$class <- paste(added_data$class, "Sintética")
        }
      }
      ...
      if (is.null(removed_data) || nrow(removed_data) == 0) {
        ...
        if ("class" %in% names(removed_data) || class_col %in% names(removed_data)) {
          ...
          removed_data$class <- paste(removed_data$class, " Removida") #ALTERADO EM 29/06/2025
        }
      }
  ...
  ##  if (!isTRUE(runSMOTETL()) && !isTRUE(runSMOTEENN()) &&  #MODIFICADO EM 03/07/2025
    ...
    if (isTRUE(runTomek())) {
     ...
     smote_data$class <- paste(smote_data$class, "Removida") #ALTERADO EM 29/06/2025
      ...
      smote_data$class <- paste(smote_data$class, "Removida")   #ADICIONADO EM 10/07/2025
    }
 ...
 ##   original_classes <- sort(unique(as.character(original_dataset$class))) #MODIFICADO 14/07/2025
   ...
   original_classes <- sort(unique(gsub(" Sintética$| Removida$", "", as.character(scores$Class))))
  ...
  ##  if (!isTRUE(runSMOTETL()) && !isTRUE(runSMOTEENN()) && !isTRUE(runSMOTEIPF()) &&    #MODIFICADO EM 13/07/2025
    ...
    if (isTRUE(runTomek()) || isTRUE(runNearMiss()) || isTRUE(runENN()) || isTRUE(runOSS()) || isTRUE(runRD()) || isTRUE(runSBC())) {
      sinteticas <- paste0(ordered_levels, " Removida") #ALTERADO EM 29/06/2025
  ...
  ##  } else if (isTRUE(runSMOTETL()) || isTRUE(runSMOTEENN()) || isTRUE(runSMOTEIPF())   ) {  #MODIFICADA EM 13/07/2025
      ...
      sinteticas <- c(paste0(ordered_levels, " Sintética"),
                      paste0(ordered_levels, " Removida")) #ALTERADO EM 29/06/2025
    } else if (
      isTRUE(runSMOTE()) || isTRUE(runSMOTENC()) || isTRUE(runBorderlineSMOTE()) ||
      isTRUE(runSVM_SMOTE()) || isTRUE(runADASYN()) || isTRUE(runRU())
    ) {
      sinteticas <- paste0(ordered_levels, " Sintética")
    } else {
  ...
  ##################### FIM BLOCO SPIDER ADICIONADO EM 14/07/2025
   ...
   ## if (!isTRUE(runSMOTETL()) &&
    ...
    if (isTRUE(runTomek()) || isTRUE(runNearMiss()) || isTRUE(runENN()) || isTRUE(runOSS()) || isTRUE(runRD()) || isTRUE(runSBC()) ) {
      smote_data$Tipo <- "Removida" #ALTERADO EM 29/06/2025
    }
  ...
  ##  if (!isTRUE(runSMOTETL()) &&
    ...
    original_classes <- unique(gsub(" (Sintética|Removida)$", "", scores$Class[!grepl("Sintética", scores$Class)]))
    derived_classes <- c(paste(original_classes, "Sintética"), paste(original_classes, "Removida")) #ALTERADO EM 29/06/2025
  ...
  # Atualização do seletor de variáveis com base no método executado
  ...
  # Função para gerar boxplot com separação total entre Original / Sintética / Removida #ALTERADO EM 29/06/2025
                 ...
                 runTomek(), runNearMiss(), runENN(), runOSS(), runRD(), runSBC() ,runSMOTETL(), runSMOTEENN(), runSMOTEIPF(), runSPIDER()   ), { #MODIFICADO EM 14/07/2025
                   ...
                   if (!is.null(syn_data_tl) && nrow(syn_data_tl) > 0) {
                     tryCatch({
                       ...
                       syn_data_tl$class <- paste(syn_data_tl$class, "Sintética")
                       syn_data_tl$fake_cat <- NULL
                     }, error = function(e) {
                       message("Erro ao processar syn_data_tl: ", e$message)
                     })
                   }
                   ...
                   if (!is.null(removed_data_tl) && nrow(removed_data_tl) > 0) {
                     tryCatch({
                       ...
                       removed_data_tl$class <- paste(removed_data_tl$class, "Removida") #ALTERADO EM 29/06/2025
                       removed_data_tl$SampleID <- NA
                       removed_data_tl$fake_cat <- NULL
                     }, error = function(e) {
                       message("Erro ao processar removed_data_tl: ", e$message)
                     })
                   }
                   ...
                   if (!is.null(syn_data_enn2) && nrow(syn_data_enn2) > 0) {
                     tryCatch({
                       ...
                       syn_data_enn2$class <- paste(syn_data_enn2$class, "Sintética")
                       syn_data_enn2$fake_cat <- NULL
                     }, error = function(e) {
                       message("Erro ao processar syn_data_enn2: ", e$message)
                     })
                   }
                   ...
                   if (!is.null(removed_data_enn2) && nrow(removed_data_enn2) > 0) {
                     tryCatch({
                       ...
                       removed_data_enn2$class <- paste(removed_data_enn2$class, "Removida") #ALTERADO EM 29/06/2025
                       removed_data_enn2$SampleID <- NA
                       removed_data_enn2$fake_cat <- NULL
                     }, error = function(e) {
                       message("Erro ao processar removed_data_enn2: ", e$message)
                     })
                   }
                   ...
                   if (!is.null(syn_data_ipf) && nrow(syn_data_ipf) > 0) {
                     tryCatch({
                       ...
                       syn_data_ipf$class <- paste(syn_data_ipf$class, "Sintética")
                       syn_data_ipf$fake_cat <- NULL
                     }, error = function(e) {
                       message("Erro ao processar syn_data_ipf: ", e$message)
                     })
                   }
                   ...
                   if (!is.null(removed_data_ipf) && nrow(removed_data_ipf) > 0) {
                     tryCatch({
                       ...
                       removed_data_ipf$class <- paste(removed_data_ipf$class, "Removida") #ALTERADO EM 29/06/2025
                       removed_data_ipf$SampleID <- NA
                       removed_data_ipf$fake_cat <- NULL
                     }, error = function(e) {
                       message("Erro ao processar removed_data_ipf: ", e$message)
                     })
                   }
                   ...
                   if (!is.null(syn_data_spider) && nrow(syn_data_spider) > 0) {
                     tryCatch({
                       ...
                       syn_data_spider$class <- paste(syn_data_spider$class, "Sintética")
                       syn_data_spider$fake_cat <- NULL
                     }, error = function(e) {
                       message("Erro ao processar syn_data_spider: ", e$message)
                     })
                   }
                   ...
                   if (!is.null(removed_data_spider) && nrow(removed_data_spider) > 0) {
                     tryCatch({
                       ...
                       removed_data_spider$class <- paste(removed_data_spider$class, "Removida") #ALTERADO EM 29/06/2025
                       removed_data_spider$SampleID <- NA
                       removed_data_spider$fake_cat <- NULL
                     }, error = function(e) {
                       message("Erro ao processar removed_data_spider: ", e$message)
                     })
                   }
  ...
  dados_filtrados_plotly <- reactive({
    ...
    df$Tipo <- ifelse(grepl("Sintética", df$class), "Sintética",
                      ifelse(grepl("Removida", df$class), "Removida", "Original")) #ALTERADO EM 29/06/2025
  ...
  plot_data_matrix <- function(centered = FALSE, y_label = "samples - raw data", titulo = "Data") {
    ...
    if (!centered) {
      ...
      df <- data.frame(
        ...
        Tipo = ifelse(grepl("Sintética", mat$class), "Sintética",
                      ifelse(grepl("Removida", mat$class), "Removida", "Original")) #ALTERADO EM 29/06/2025
    ...
    original_classes <- unique(gsub(" Sintética$| Removida$", "", df$class)) #ALTERADO EM 29/06/2025
    
    
    #orig_classes_all <- unique(gsub(" Sintética$", "", combined_data()$class[!grepl("Sintética", combined_data()$class)]))
    
    #orig_classes_all <- unique(gsub(" Sintética$| Removida$", "", combined_data()$class[!grepl("Sintética| Removida", combined_data()$class)])) #ALTERADO EM 29/06/2025
    
    
    orig_classes_all <- unique(gsub(" Sintética$| Removida$", "", combined_data()$class))
    ...
    all_classes <- unique(c(orig_classes_all, paste0(orig_classes_all, " Sintética"), paste0(orig_classes_all, "Removida"))) #ALTERADO EM 29/06/2025
    ...
    # ordered_levels <- c(rbind(orig_classes_all, paste0(orig_classes_all, " Sintética"), paste0(orig_classes_all, "Removida"))) #ALTERADO EM 29/06/2025
    
    
    ordered_levels <- c(rbind(orig_classes_all,
                              paste0(orig_classes_all, " Sintética"),
                              paste0(orig_classes_all, " Removida"))) #ALTERADO EM 29/06/2025
    ...
    if (input$coloring_type == "class") {
      ...
      for (classe in class_levels) {
        ...
        dash_style <- ifelse(grepl("Sintética", classe), "dot",
                             ifelse(grepl("Removida", classe), "dash", "solid")) #ALTERADO EM 29/06/2025
      ...
      for (i in unique(df_long$SampleID)) {
        ...
        dash_style <- ifelse(grepl("Sintética", classe_i), "dot",
                             ifelse(grepl("Removida", classe_i), "dash", "solid")) #ALTERADO EM 29/06/2025
  ...
  js_div_data <- reactive({
    ...
    if (isTRUE(runSMOTENC()) && !is.null(SMOTENC_Data()) && !is.null(input$target_nc)) {
      ...
      if (nrow(added_data) > 0) {
        added_data$class <- paste(added_data$class, "Sintética")
        added_data$Tipo <- "Sintética"
      }
      
      if (nrow(removed_data) > 0) {
        removed_data$class <- paste(removed_data$class, "Removida") #ALTERADO EM 29/06/2025
        removed_data$Tipo <- "Removida" #ALTERADO EM 29/06/2025
      }
      ...
      df_tl$classe_base <- gsub(" Sintética$", "", gsub(" Removida$", "", df_tl$class)) #ALTERADO EM 29/06/2025
      ...
      for (cl in classes) {
        ...
        df_a <- df_tl %>% dplyr::filter(classe_base == cl & Tipo == "Sintética")
        df_r <- df_tl %>% dplyr::filter(classe_base == cl & Tipo == "Removida") #ALTERADO EM 29/06/2025
      ...
      if (nrow(resultado) > 0) {
        resultado$Comparado_com <- "Sintética e/ou Removida" #ALTERADO EM 29/06/2025
  ...
  #  }
        ...
        output$js_divergence_plot <- renderPlotly({
          ...
          if (ncol(df_wide) == 1) {
            return(plotly_empty(type = "scatter", mode = "markers") %>%
                     layout(title = "Nenhuma divergência calculada para as variáveis"))
          }
            ...
            plot <- plot %>%
              add_trace(
                ...
                text = paste0(
                  ...
                  "<br><b>Comparada com:</b> Sintética e Removida",
                  "<br><b>Variável:</b> ", variaveis,
                  "<br><b>Divergência JS:</b> ", ifelse(is.na(df_wide[[classe_nome]]), "NA", round(as.numeric(df_wide[[classe_nome]]), 4))
                ),
          ...
          plot %>% layout(
            title = list(text = "Divergência de Jensen-Shannon: Originais vs Sintéticas e Removidas", font = list(size = 18)),
...
################################################BLOCO ADICIONADO EM 04/07/2025
      ...
      df_enn2$classe_base <- gsub(" Sintética$", "", gsub(" Removida$", "", df_enn2$class)) #ALTERADO EM 29/06/2025
      ...
      for (cl in classes) {
        ...
        df_a <- df_enn2 %>% dplyr::filter(classe_base == cl & Tipo == "Sintética")
        df_r <- df_enn2 %>% dplyr::filter(classe_base == cl & Tipo == "Removida") #ALTERADO EM 29/06/2025
...
################################################BLOCO ADICIONADO EM 04/07/2025    
    ...
    ################################################BLOCO ADICIONADO EM 13/07/2025
      ...
      df_ipf$classe_base <- gsub(" Sintética$", "", gsub(" Removida$", "", df_ipf$class)) #ALTERADO EM 29/06/2025
      ...
      for (cl in classes) {
        ...
        df_a <- df_ipf %>% dplyr::filter(classe_base == cl & Tipo == "Sintética")
        df_r <- df_ipf %>% dplyr::filter(classe_base == cl & Tipo == "Removida") #ALTERADO EM 29/06/2025
    ...
    ################################################ BLOCO SPIDER ADAPTADO EM 14/07/2025
      ...
      df_spider$classe_base <- gsub(" Sintética$", "", gsub(" Removida$", "", df_spider$class)) #ALTERADO EM 29/06/2025
      ...
      for (cl in classes) {
        ...
        df_a <- df_spider %>% dplyr::filter(classe_base == cl & Tipo == "Sintética")
        df_r <- df_spider %>% dplyr::filter(classe_base == cl & Tipo == "Removida") #ALTERADO EM 29/06/2025
    ...
    suffix <- if (isTRUE(runTomek()) || isTRUE(runNearMiss()) 
                  || isTRUE(runENN())  || isTRUE(runOSS())  || isTRUE(runRD()) || isTRUE(runSBC())     ) "Removida" else "Sintética" #ALTERADO EM 10/07/2025
    ...
    # Reconverte todas variáveis para numéricas (exceto class, Tipo, classe_base)
    ...
    df$classe_base <- gsub(" Sintética$| Removida$", "", df$class) #ALTERADO EM 29/06/2025
    #########MODIFICADO EM 11/06/2025
    ...
    for (cl in classes) {
      ...
      ## tipo_sintetico <- if (isTRUE(runTomek())) "Removida" else "Sintética"
      tipo_sintetico <- if (isTRUE(runTomek()) || isTRUE(runNearMiss()) 
                            || isTRUE(runENN()) || isTRUE(runOSS()) || isTRUE(runRD()) || isTRUE(runSBC()) ) "Removida" else "Sintética"
    ...
    if (nrow(resultado) > 0) {  #LINHA ADICIONADA EM 20/06/2025
      ...
      for (i in seq_len(nrow(resultado))) {
        ...
        if ("Removida" %in% tipos) {
          resultado$Comparado_com[i] <- "Removida" #ALTERADO EM 29/06/2025
        } else if ("Sintética" %in% tipos) {
          resultado$Comparado_com[i] <- "Sintética"
        } else {
  ...
  output$js_divergence_plot <- renderPlotly({
    ...
    for (i in seq_along(classe_cols)) {
      classe_nome <- classe_cols[i]
      #comparado_com <- if (any(grepl("Removida", classe_nome))) "Removida" else "Sintética" #ADICIONADA EM 11/06/2025 #ALTERADO EM 29/06/2025
      ...
      plot <- plot %>%
        add_trace(
          ...
          text = paste0(
            ...
            # "<br><b>Comparada com:</b> ", classe_nome, " ", comparado_com,
            
            ##  "<br><b>Comparada com:</b> ", comparado_com,
  ...
  output$js_distributions_plot <- renderPlotly({
    ...
    if (isTRUE(runSMOTETL()) && !is.null(SMOTETL_Data()) && !is.null(input$target_tl)) {
      ...
      if (!is.null(smote_data_added) && nrow(smote_data_added) > 0) {
        ...
        smote_data_added$class <- paste(smote_data_added$class, "Sintética")
        smote_data_added$Tipo <- "Sintética"
      } else {
      ...
      if (!is.null(smote_data_removed) && nrow(smote_data_removed) > 0) {
        ...
        smote_data_removed$class <- paste(smote_data_removed$class, "Removida") #ALTERADO EM 29/06/2025
        smote_data_removed$Tipo <- "Removida"
      } else {
      ...
      df_full$classe_base <- gsub(" Sintética$| Removida$", "", df_full$class) #ALTERADO EM 29/06/2025
    ...
    if (length(tipos_unicos) == 1 && tipos_unicos == "Original") {
      showNotification("Apenas dados Originais disponíveis para esta classe", type = "message")
  ...
  output$grafico_procrustes_multiclasse <- renderPlotly({
    ...
    if (isTRUE(runSMOTETL()) && !is.null(SMOTETL_Data()) && !is.null(input$target_tl)) {
      ...
      if (!is.null(smote_data_removed) && nrow(smote_data_removed) > 0) {
        names(smote_data_removed)[names(smote_data_removed) == class_col] <- "class"
        smote_data_removed$class <- paste(smote_data_removed$class, "Removida")
        smote_data_removed$Tipo <- "Removida"
      } else {
        smote_data_removed <- original_data[0, , drop = FALSE]
      }
      ...
      dados$classe_base <- gsub(" Sintética$| Removida$", "", dados$class)
    ...
    ##########################BLOCO ADICIONADO EM 13/07/2025
      ...
      if (!is.null(smote_data) && !is.null(class_col) && class_col %in% names(original_data)) {
        ...
        suffix <- if (isTRUE(runTomek()) || isTRUE(runNearMiss()) || isTRUE(runOSS()) ||
                      isTRUE(runENN()) || isTRUE(runRD())  || isTRUE(runSBC())  ) "Removida" else "Sintética"
    ...
    classes_sinteticas <- unique(dados$classe_base[dados$Tipo == "Sintética"])
    classes_removidas  <- unique(dados$classe_base[dados$Tipo == "Removida"])
  ...
  #  if (isTRUE(runSMOTETL()) || isTRUE(runSMOTEENN()) ) { #MODIFICADO EM 05/07/2025
    ...
    if (isTRUE(runSMOTETL()) || isTRUE(runSMOTEENN())  || isTRUE(runSMOTEIPF()) || isTRUE(runSPIDER())   ) { #MODIFICADO EM 14/07/2025
      ...
      for (classe in intersect(classes_originais, classes_sinteticas)) {
        p <- compara_procrustes(p, dados, classe, num_vars, "Sintética")
        alguma_classe_foi_plotada <- TRUE
      }
      for (classe in intersect(classes_originais, classes_removidas)) {
        p <- compara_procrustes(p, dados, classe, num_vars, "Removida")
        alguma_classe_foi_plotada <- TRUE
      }
  ...
  mahalanobis_resultados <- reactive({
    ...
    if (isTRUE(runSMOTETL()) && !is.null(SMOTETL_Data()) && !is.null(input$target_tl)) {
      ...
      dados <- dplyr::bind_rows(original_data, smote_data)
      dados$class <- as.character(dados$class)
      dados$Tipo <- ifelse(grepl("Removida$", dados$class), "Removida",
                           ifelse(grepl("Sintética$", dados$class), "Sintética", "Original"))
      dados$classe_base <- gsub(" Sintética$| Removida$", "", dados$class)
   ...
   #   }
      ...
      suffix <- if (isTRUE(runTomek()) || isTRUE(runNearMiss()) || isTRUE(runENN()) ||
                    isTRUE(runOSS()) || isTRUE(runRD())  || isTRUE(runSBC())      ) "Removida" else "Sintética"
  ...
  #  tipos <- if (isTRUE(runSMOTETL())) c("Sintética", "Removida") else unique(dados$Tipo[dados$Tipo != "Original"])
    
    ## tipos <- if (isTRUE(runSMOTETL()) || isTRUE(runSMOTEENN())  ) c("Sintética", "Removida") else unique(dados$Tipo[dados$Tipo != "Original"])
    
    
    tipos <- if (isTRUE(runSMOTETL()) || isTRUE(runSMOTEENN())  || isTRUE(runSMOTEIPF()) || isTRUE(runSPIDER())   ) c("Sintética", "Removida") else unique(dados$Tipo[dados$Tipo != "Original"])
  ...
  #######ACRÉSCIMO DE TOMEK LINKS EM TESTE DE PROCRUSTE GENERALIZADO EM 14/06/2025 #######
  
  #######ACRÉSCIMO DE NEAR MISS EM TESTE DE PROCRUSTE GENERALIZADO EM 17/06/2025 #######
  
  #######ACRÉSCIMO DE ENN EM TESTE DE PROCRUSTE GENERALIZADO EM 17/06/2025 #######
  
  #######ACRÉSCIMO DE OSS EM TESTE DE PROCRUSTE GENERALIZADO EM 18/06/2025 #######
  
  ######ACRÉSCIMO DE RANDOM DOWNSAMPLING EM TESTE DE PROCRUSTE GENERALIZADO EM 18/06/2025######
  
  ######ACRÉSCIMO DE SMOTE TL EM TESTE DE PROCRUSTE GENERALIZADO EM 02/07/2025######
  
  ######ACRÉSCIMO DE SMOTE ENN EM TESTE DE PROCRUSTE GENERALIZADO EM 05/07/2025######
  
  ######ACRÉSCIMO DE SBC EM TESTE DE PROCRUSTE GENERALIZADO EM 10/07/2025######
  
  ######ACRÉSCIMO DE SMOTE IPF EM TESTE DE PROCRUSTE GENERALIZADO EM 14/07/2025######
  
  ######ACRÉSCIMO DE SPIDER EM TESTE DE PROCRUSTE GENERALIZADO EM 14/07/2025######
    ...
    for (classe in unique(dados$classe_base)) {
      for (tipo in tipos) {
        ...
        if (n >= 2) {
          ...
          # Removendo variáveis com desvio padrão zero ou NA
  ...
  #######ACRÉSCIMO DE OSS EM TESTE DE PROCRUSTE GENERALIZADO EM 17/06/2025 #######
  
  ######ACRÉSCIMO DE RANDOM DOWNSAMPLING EM TESTE DE PROCRUSTE GENERALIZADO EM 18/06/2025######
  
  ######ACRÉSCIMO DE SMOTE TL EM TESTE DE PROCRUSTE GENERALIZADO EM 02/07/2025######
  
  ######ACRÉSCIMO DE SMOTE ENN EM TESTE DE PROCRUSTE GENERALIZADO EM 02/07/2025######
  ...
  ######ACRÉSCIMO DE TOMEK LINKS EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 14/06/2025
  
  ######ACRÉSCIMO DE NEAR MISS EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 17/06/2025
  
  ######ACRÉSCIMO DE ENN EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 17/06/2025
  
  ######ACRÉSCIMO DE OSS EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 18/06/2025
  
  ######ACRÉSCIMO DE RANDOM DOWNSAMPLING EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 18/06/2025
  
  ######ACRÉSCIMO DE SMOTE TL EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 02/07/2025
  
  ######ACRÉSCIMO DE SMOTE ENN EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 05/07/2025
  
  ######ACRÉSCIMO DE SBC EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 10/07/2025
  
  ######ACRÉSCIMO DE SMOTE IPF EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 14/07/2025
  
  ######ACRÉSCIMO DE SPIDER EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 14/07/2025
  ...
  ##  if (!isTRUE(runSMOTETL()) && !isTRUE(runSMOTEENN()) && !isTRUE(runSMOTEIPF()) ) {  #MODIFICADO EM 14/07/2025
    ...
    if (!isTRUE(runSMOTETL()) && !isTRUE(runSMOTEENN()) && !isTRUE(runSMOTEIPF()) && !isTRUE(runSPIDER()) ) {  #MODIFICADO EM 14/07/2025
      ...
      if (nrow(smote_data) > 0) {
        ...
        showNotification("Nenhuma amostra sintética/removida foi gerada para esse método.", type = "warning")
        return()
      }
    ...
    if (length(classes_com_sintetica) == 0) {
      output$normalidade_table <- renderDataTable({ datatable(data.frame()) })
    ...
    #  classe_sint <- paste(classe, ifelse(isTRUE(runSMOTETL()), "Sintética", suffix))
      
      
     ## classe_sint <- paste(classe, ifelse(isTRUE(runSMOTETL() ||  isTRUE(runSMOTEENN()) ), "Sintética", suffix))
      
      classe_sint <- paste(classe, ifelse(isTRUE(runSMOTETL() ||  isTRUE(runSMOTEENN()) ||  isTRUE(runSMOTEIPF()) ||  isTRUE(runSPIDER()) ), "Sintética", suffix))
      ...
      hz_val <- p_hz <- NA; status_hz <- "Erro"
      roy_val <- p_roy <- NA; status_roy <- "Erro"
    ...
    output$normalidade_table <- DT::renderDataTable({
      DT::datatable(df_normalidade, rownames = FALSE, options = list(pageLength = 10))
    })
    ...
    resultados_hotelling <- lapply(classes_com_sintetica, function(classe) {
      ...
      resultado <- tryCatch({
        ...
        data.frame(Classe = classe, Hotelling_T2 = round(T2_stat, 4), p_valor = round(pval, 4), Nota = "OK")
      }, error = function(e) {
  ...
  ######ACRÉSCIMO DE RANDOM DOWNSAMPLING EM TESTE DE ROYSTON e TESTE DE NORMALIDADE MULTIVARIADA EM 09/06/2025
  ...
  ######ACRÉSCIMO DE TOMEK LINKS EM TESTE PERMANOVA EM 14/06/2025
  
  ######ACRÉSCIMO DE NEAR MISS EM TESTE PERMANOVA EM 17/06/2025
  
  ######ACRÉSCIMO DE ENN EM TESTE PERMANOVA EM 17/06/2025
  
  ######ACRÉSCIMO DE OSS EM TESTE PERMANOVA EM 18/06/2025
  
  ######ACRÉSCIMO DE RANDOM DOWNSAMPLING EM TESTE PERMANOVA EM 18/06/2025
  
  ######ACRÉSCIMO DE SMOTE TL EM TESTE PERMANOVA EM 02/07/2025
  
  ######ACRÉSCIMO DE SMOTE ENN EM TESTE PERMANOVA EM 02/07/2025
  
  ######ACRÉSCIMO DE SBC EM TESTE PERMANOVA EM 10/07/2025
  
  ######ACRÉSCIMO DE SMOTE IPF EM TESTE PERMANOVA EM 14/07/2025
  
  ######ACRÉSCIMO DE SPIDER EM TESTE PERMANOVA EM 14/07/2025
  ...
  ##  if (!isTRUE(runSMOTETL()) && !isTRUE(runSMOTEENN()) && !isTRUE(runSMOTEIPF()) ) {  #MODIFICADO EM 14/07/2025
    ...
    if (is.null(smote_data) || !(class_col %in% names(original_data))) return()
      ...
      if (nrow(smote_data) == 0) {
        ...
        showNotification("Nenhuma amostra sintética/removida encontrada.", type = "warning", duration = 60)
        showNotification("Não visualize diagnóstico. Por favor utilize outro método", type = "warning", duration = 60)
        output$permanova_table <- renderDataTable({
          datatable(data.frame(Classe = character(0), F_model = numeric(0), R2 = numeric(0), p_valor = numeric(0)),
                    caption = "Nenhuma amostra sintética/removida foi gerada.")
        })
        return()
      }
    ...
    if (length(classes_com_sintetica) == 0) {
      output$permanova_table <- renderDataTable({
        datatable(data.frame(Classe = character(0), F_model = numeric(0), R2 = numeric(0), p_valor = numeric(0)),
                  caption = "Nenhuma classe possui amostras sintéticas/removidas para comparação.")
      })
      return()
    }
    ...
    resultados_permanova <- lapply(classes_com_sintetica, function(classe) {
     ...
     # tipos <- if (isTRUE(runSMOTETL())) c("Sintética", "Removida") else "Sintética"
      
      
      ## tipos <- if (isTRUE(runSMOTETL()) || isTRUE(runSMOTEENN()) ) c("Sintética", "Removida") else "Sintética"
      tipos <- if (isTRUE(runSMOTETL()) || isTRUE(runSMOTEENN()) || isTRUE(runSMOTEIPF()) || isTRUE(runSPIDER()) ) c("Sintética", "Removida") else "Sintética"
      ...
      res_list <- lapply(tipos, function(tipo) {
        ...
        if (ncol(X) < 2) {
          return(data.frame(Classe = classe, Tipo = tipo, F_model = NA, p_valor = NA))
        }
        ...
        resultado <- tryCatch({
          ...
          data.frame(Classe = classe, Tipo = tipo, F_model = NA, p_valor = NA)
        })
  ...
  ######ACRÉSCIMO DE SMOTE ENN EM TESTE PERMANOVA EM 05/07/2025
  ...
  observeEvent(input$confirmSMOTE, {
    ...
    synthetic$sampleclass.. <- paste(synthetic$sampleclass.., "Sintética") #ADICIONADO EM 14/06/2025
  ...
  observeEvent(input$confirmTomek, {
    ...
    original <- filedata()
    removidas <- Tomek_Data()$removed_data  # Aqui as "sintéticas" são as removidas
  ...
  observeEvent(input$confirmNearMiss, {
    ...
    original <- filedata()
    removidas <- NearMiss_Data()$removed_data  # Aqui as "sintéticas" são as removidas
  ...
  observeEvent(input$confirmENN, {
    ...
    original <- filedata()
    removidas <- ENN_Data()$removed_data  # Aqui as "sintéticas" são as removidas
  ...
  observeEvent(input$confirmOSS, {
    ...
    original <- filedata()
    removidas <- OSS_Data()$removed_data  # Aqui as "sintéticas" são as removidas
  ...
  observeEvent(input$confirmRD, {
    ...
    original <- filedata()
    removidas <- RD_Data()$removed_data  # Aqui as "sintéticas" são as removidas
  ...
  observeEvent(input$confirmSMOTETL, {
    ...
    ##  added$sampleclass.. <- paste(added$sampleclass.., "Sintética")
  ##  }
  ...
  ##  combined_data$class <- as.character(combined_data$class)
    ...
    if (!"Tipo" %in% names(combined_data)) {
      combined_data$Tipo <- ifelse(grepl("Sintética", combined_data$class), "Sintética",
                                   ifelse(grepl("Removida", combined_data$class), "Removida", "Original"))
    }
    ...
    base_classes <- gsub(" Sintética.*$| Removida.*$", "", classes_ordered)
    classes_ordered <- unique(unlist(lapply(unique(base_classes), function(cls) {
      c(cls, paste0(cls, " Sintética"), paste0(cls, " Removida"))
    })))
  ...
  combined_data_reactive <- reactive({
    if (!is.null(SMOTETL_Data())) {
      ...
      if (!is.null(smote_data_added) && nrow(smote_data_added) > 0) {
        names(smote_data_added)[names(smote_data_added) == class_col] <- "class"
        smote_data_added$class <- paste0(smote_data_added$class, " Sintética")
        smote_data_added$Tipo <- "Sintética"
      } else {
        smote_data_added <- original_data[0, , drop = FALSE]
      }
      ...
      if (!is.null(smote_data_removed) && nrow(smote_data_removed) > 0) {
        names(smote_data_removed)[names(smote_data_removed) == class_col] <- "class"
        smote_data_removed$class <- paste0(smote_data_removed$class, " Removida")
        smote_data_removed$Tipo <- "Removida"
      } else {
        smote_data_removed <- original_data[0, , drop = FALSE]
      }
    ...
    ###########################BLOCO ADICIONADO EM 14/07/2025
      ...
      class_col <- input$target_tomek
      sint_type <- "Removida" #ALTERADO EM 29/06/2025
  ...
  observe({
    ...
    base_classes <- gsub(" Removida| Sintética", "", classes) #MODIFICADO EM 15/06/2025 #ALTERADO EM 29/06/2025
    ...
    classes_ordenadas <- unique(unlist(lapply(unique(base_classes), function(cls) {
      c(
        cls,
        paste0(cls, " Sintética"),
        paste0(cls, " Removida") #ALTERADO EM 29/06/2025
      )
    })))
  ...
  # Testes de variância - ACRÉSCIMO DE TOMEK LINKS 15/06/2025   
  
  # Testes de variância - ACRÉSCIMO DE NEAR MISS 17/06/2025     
  
  # Testes de variância - ACRÉSCIMO DE ENN 17/06/2025
  
  # Testes de variância - ACRÉSCIMO DE OSS 18/06/2025  
  
  # Testes de variância - ACRÉSCIMO DE RANDOM DOWNSAMPLING 18/06/2025 
  
  # Testes de variância - ACRÉSCIMO DE SMOTE TL 02/07/2025 
  
  # Testes de variância - ACRÉSCIMO DE SMOTE ENN 05/07/2025 
  
  # Testes de variância - ACRÉSCIMO DE SBC 10/07/2025
  
  # Testes de variância - ACRÉSCIMO DE SMOTE IPF 14/07/2025 
  
  # Testes de variância - ACRÉSCIMO DE SPIDER 14/07/2025 
  ...
  observeEvent(input$run_variance_test, {
    ...
    ##############BLOCO ADICIONADO EM 14/07/2025
      ...
      showNotification("Execute algum método de amostragem antes de rodar o teste.", type = "error")
      return(NULL)
    }
...
##    }
    ...
    if (nrow(smote_data) == 0 || !"class" %in% names(smote_data)) {
      showNotification("Nenhuma amostra sintética/removida gerada ou coluna de classe ausente.", type = "error")
      return(NULL)
    }
  ...
  ##  if (isTRUE(runSMOTETL()) || isTRUE(runSMOTEENN()) || isTRUE(runSMOTEIPF())  ) { #MODIFICADO EM 14/07/2025
    ...
    original_dataset <- dataset[!grepl("Sintética|Removida", dataset$class), ]
    synthetic_dataset <- dataset[grepl("Sintética|Removida", dataset$class), ]
    
    if (nrow(synthetic_dataset) > 0) {
      synthetic_dataset$OriginalClass <- gsub(" Removida| Sintética", "", synthetic_dataset$class)
    }
